    					...
    					if (leftDistance > 30) {
    						if (rightDistance > 30) {
    							if (IRDistanceLeft != -2 && IRDistanceRight != -2) {
    								...
    								//TODO Keine Fernbedienung || Nur 1 Sensor erkennt Fernbedienung
    								if (IRDistanceLeft == -2 && IRDistanceRight == -2) {
    							...
    							//TODO Wand rechts -> Nach Links drehen + In Liste eintragen
    						}
    					} else {
    						//TODO Wand links -> Nach Rechts drehen + In Liste eintragen
    					}
    				} else {
						//TODO Treppe || "Abgrund" -> Stoppen + In Liste eintragen
    					navigator.stop();
						Path currentPath = navigator.getPath();
